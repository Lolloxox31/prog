        ...
        <div class="container px-1 px-lg-1">
            ...
            <div class="collapse navbar-collapse flo" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto my-2 my-lg-0 text-center">
                    ...
                    <li class="nav-item p-1"><a class="nav-link" href="../blog/pagina2.php">Blog</a></li>
        ...
        <div class="container">
            <nav id="paginazione" aria-label="Page navigation example">
                <ul class="pagination pagination-lg">
                    <li  class="page-item"><a class="page-link" href="pagina1.php#paginazione">1</a></li>
    ...
    <div class="bg-light" id="footer">
        <div class="container">
            <footer class="py-5">
                ...
                <div class="col-lg-4 ">
                    <form id="newsletterForm" action="pagina2.php#footer" method="POST"  onsubmit="return validaIscrizione();" >
